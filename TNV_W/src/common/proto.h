...
#define ERROR_DESC_SIZE 1024	// 错误描述最大字节数（包含空字符）

//	| 包体长度 | 命令 | 状态 | 应用ID | 用户ID | 文件ID |
//	|     8    |  1   |   1  |   16   |   256  |   128  |
//
#define APPID_SIZE   16 	// 应用ID最大字节数（含空字符）
#define USERID_SIZE 256		// 用户ID最大字节数（含空字符）
#define FILEID_SIZE 128		// 文件ID最大字节数（含空字符）
...
#define CMD_TRACKER_SADDRS  12  //客户机从跟踪服务器获取在储服务器地址列表
